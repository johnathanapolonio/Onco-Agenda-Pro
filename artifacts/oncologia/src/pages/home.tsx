            ...
            <div className="max-w-xl flex flex-col gap-7 py-28 md:py-0">
              ...
              >
                <Link
                  ...
                  href="/agendar"
                  className="inline-flex h-12 items-center justify-center rounded-md px-8 text-sm font-semibold shadow-lg transition-all focus-visible:outline-none"
                  style={{ background: "linear-gradient(135deg, #b8935a, #d4aa72)", color: "#0f0c09" }}
                >
                  Agendar Consulta
                </Link>
                <a
                  ...
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-md px-6 text-sm font-semibold transition-all"
                  style={{ border: "1px solid rgba(37,211,102,0.35)", background: "rgba(37,211,102,0.06)", color: "#4ade80" }}
                >
