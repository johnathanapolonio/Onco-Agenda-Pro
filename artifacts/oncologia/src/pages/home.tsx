  ...
  return (
    <Layout>
      ...
      <section className="relative w-full min-h-screen flex items-center overflow-hidden" style={{ background: "#0a0f0d" }}>
        ...
        <div className="container px-4 md:px-8 py-28 md:py-0 max-w-4xl mx-auto flex flex-col items-center text-center relative z-10 gap-9">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-1.5 rounded-full text-xs font-medium tracking-widest uppercase"
          ...
          <motion.h1
            ...
            style={{ fontSize: "clamp(2.6rem, 7vw, 5.2rem)", fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic" }}
          >
          ...
          >
            <span
              ...
              style={{ fontSize: "clamp(1rem, 2.5vw, 1.25rem)", fontFamily: "'Plus Jakarta Sans', sans-serif" }}
            >
              Dr. Johnathan Gabriel Rodrigues Apolonio
            </span>
            {/* Animated decorative line under name */}
            <motion.div
              initial={{ scaleX: 0, opacity: 0 }}
              animate={{ scaleX: 1, opacity: 1 }}
              transition={{ duration: 1.4, delay: 0.9, ease: [0.22, 1, 0.36, 1] }}
              style={{ originX: 0.5, height: "1px", width: "120px", background: "linear-gradient(90deg, transparent, #c9a96e, transparent)" }}
            />
          </motion.div>
          ...
          >
            <Link
              ...
              href="/agendar"
              className="inline-flex h-13 items-center justify-center rounded-md px-10 py-3 text-base font-semibold shadow-lg transition-all focus-visible:outline-none"
            ...
            <a
              ...
              className="inline-flex h-13 items-center justify-center gap-2 rounded-md px-8 py-3 text-base font-semibold transition-all"
              style={{ border: "1px solid rgba(37,211,102,0.4)", background: "rgba(37,211,102,0.08)", color: "#4ade80" }}
            >
