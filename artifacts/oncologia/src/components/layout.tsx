      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4 md:px-8 max-w-7xl mx-auto">
          ...
          <nav className="flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/chat" className="transition-colors hover:text-primary">Tirar Dúvidas</Link>
        ...
        <div className="container px-4 md:px-8 py-12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground flex flex-col">
              ...
              <Link href="/chat" className="hover:text-primary transition-colors w-fit">Tirar Dúvidas</Link>
            </ul>
          </div>
        </div>
