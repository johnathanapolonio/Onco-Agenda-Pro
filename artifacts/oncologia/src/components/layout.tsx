    ...
    <div className="min-h-screen flex flex-col font-sans bg-background text-foreground">
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-8 max-w-7xl mx-auto">
          ...
          <nav className="flex items-center gap-4 text-sm font-medium shrink-0 ml-4">
            ...
            <a
              ...
              className="inline-flex h-9 items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-semibold shadow transition-all"
              style={{ background: "linear-gradient(135deg, #1db954, #25D366)", color: "#fff" }}
            >
      ...
      <footer className="border-t border-border bg-secondary/30 mt-auto">
        <div className="container px-4 md:px-8 py-12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="font-serif text-lg font-bold text-primary mb-2">Dr. Johnathan Gabriel Rodrigues Apolonio</div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              ...
              <li className="mb-3">(41) 3136-2515</li>
              <li className="font-medium text-foreground">Clínica São Vicente — Araucária</li>
              <li>(41) 3552-4000</li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-border py-6">
          <div className="container text-center text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Dr. Johnathan Gabriel Rodrigues Apolonio — CRM-PR 41.248. Todos os direitos reservados.
          </div>
        </div>
      </footer>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white rounded-full shadow-2xl px-5 py-4 font-semibold text-sm hover:bg-[#1ebe5a] transition-colors"
        style={{
